...
extension Calculator {
    ...
    mutating func processOperation(_ operation: String){
        ...
        case "PSUM":
            xRegisterNew = (yRegister * xRegister) / (yRegister + xRegister)
        case "RSS":
            xRegisterNew = sqrt(yRegister * yRegister + xRegister * xRegister)
        case "DBSUM":
            xRegisterNew = 10 * log10(pow(10, yRegister / 10) + pow(10, xRegister / 10))
        case "√x":
