    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ...
            HStack(spacing: 0) {
                ...
                OperatorButton(operatorString: "±", bgColor: self.dataRouter.myColors.secondaryButtonColor, bgColor1: self.dataRouter.myColors.secondaryButtonColor, highlightColor: self.dataRouter.myColors.secondaryShortPressColor, highlightColor2: self.dataRouter.myColors.secondaryShortPressColor, fontColor: self.dataRouter.myColors.brightButtonTextColor, font: self.dataRouter.myFonts.digitFont, width: geometry.size.width / self.dataRouter.rowUnits, height: geometry.size.height)
                .frame(width: geometry.size.width / self.dataRouter.rowUnits, height: geometry.size.height)
